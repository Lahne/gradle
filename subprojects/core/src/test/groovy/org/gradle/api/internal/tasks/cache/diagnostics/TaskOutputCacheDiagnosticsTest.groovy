...
@Subject(TaskOutputCacheDiagnostics)
class TaskOutputCacheDiagnosticsTest extends Specification {
    private diagnostics = new TaskOutputCacheDiagnostics()
